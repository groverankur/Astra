...
from astraauth_core.authorization.models import Decision, PolicyRule, Role, TenantRoleAssignment
...
def main() -> None:
    ...
    assignments.assign(TenantRoleAssignment(subject_id='user-1', tenant_id='tenant-1', roles={'finance_admin'}))
    policies.add_policy(
        PolicyRule(
