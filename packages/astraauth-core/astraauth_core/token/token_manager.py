...
from astraauth_core.errors import (
    TokenExpiredError,
    TokenValidationError,
    TokenVersionError,
)
from astraauth_core.ids import new_uuid7_str
from astraauth_core.token.store import InMemoryKeyStore, KeyMetadata
from astraauth_core.version import TOKEN_SCHEMA_VERSION
...
class TokenKeyManager:
    ...
    def __init__(self, config: AuthConfig, *, serialized_state: dict[str, Any] | None = None) -> None:
        config.validate()
        self._config = config
