...
from astraauth_core.authorization.models import PolicyRule, Role, TenantRoleAssignment
...
class InMemoryPolicyStore(PolicyStore):
    ...
    def list_policies(self, *, permission: str, tenant_id: str) -> Iterable[PolicyRule]:
        return tuple(
            ...
            if policy.permission == permission and (policy.tenant_id is None or policy.tenant_id == tenant_id)
        )
