...
class IdentityLinkRepository(Protocol):
    ...
    def get(self, *, provider_id: str, external_subject: str, tenant_id: str) -> ExternalIdentityLink | None: ...
...
class ClaimAttributeMappingRepository(Protocol):
    ...
    def list_for_provider(self, *, provider_id: str, tenant_id: str) -> Iterable[ClaimAttributeMapping]: ...
...
class FederationAuditRepository(Protocol):
    ...
    def list_for_tenant(self, *, tenant_id: str, provider_id: str | None = None) -> Iterable[FederationAuditRecord]: ...
...
class InMemoryFederationAuditRepository(FederationAuditRepository):
    ...
    def list_for_tenant(self, *, tenant_id: str, provider_id: str | None = None) -> Iterable[FederationAuditRecord]:
        return tuple(
            ...
            if record.tenant_id == tenant_id and (provider_id is None or record.provider_id == provider_id)
        )
